...
/**
 * The contract of the Local filesystem on hadoop 3.2.0
 */
public class Release32Contract extends AbstractFSContract {
  ...
  public Release32Contract(Configuration conf) {
    super(conf);
